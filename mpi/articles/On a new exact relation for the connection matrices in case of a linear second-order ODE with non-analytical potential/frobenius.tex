...
\runningtitle{On a new exact relation for the connection matrices in the phase-integral method}

\author{\inits{A.G.}\fnms{Anton} \snm{Kutlin}\ead[label=e1]{anton.kutlin@gmail.com}}
\address{
%Department first, 
\institution{Institute of Applied Physics of Russian Academy of Sciences},
Nizhny Novgorod 603950, \cny{Russia}\printead[presep={\\}]{e1}}
\runningauthor{A.G. Kutlin}
...
\begin{keyword}
\kwd{Stokes phenomenon}
\kwd{phase-integral method}
\kwd{Frobenius method}
\end{keyword}
